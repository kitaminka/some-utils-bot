...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        if (embedInfo.author.name && embedInfo.author.image && embedInfo.author.url) embed.setAuthor(embedInfo.author.name, embedInfo.author.image, embedInfo.author.url);
        ...
        if (embedInfo.footer.text && embedInfo.footer.image) embed.setFooter(embedInfo.footer.text, embedInfo.footer.image);
        if (embedInfo.timestamp) embed.setTimestamp(embedInfo.timestamp);
